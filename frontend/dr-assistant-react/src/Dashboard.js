...
// // //     if (total >= 6)
// // //       return <span className="criticality critical">Critical (4)</span>;
// // //     if (total >= 4)
// // //       return <span className="criticality high">High (3)</span>;
// // //     if (total >= 2)
// // //       return <span className="criticality medium">Medium (2)</span>;
// // //     return <span className="criticality low">Low (1)</span>;
// // //   };
...
//                   fill={["#2196f3", "#ffeb3b", "#ff9800", "#f44336"][index % 4]}
//                 />
//               ))}
//               <LabelList dataKey="name" position="outside" />
//             </Pie>
