...
// function RequestApproval({ system, user, onRequestSubmit }) {
...
//     e.preventDefault();
//     if (!reason.trim()) {
//       setMessage('Please enter a reason for approval request');
//       return;
//     }
...
//       <h3>Request Approval for {system.name}</h3>
//       <form onSubmit={handleSubmit}>
//         <div className="form-group">
//           <label>Reason for Approval Request:</label>
//           <textarea
//             value={reason}
