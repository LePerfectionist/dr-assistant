...
// --- 1. IMPORT THE PLUGIN AND A THEME ---
import rehypeHighlight from 'rehype-highlight';
import 'highlight.js/styles/github-dark.css'; // This theme provides the colors
...
function App() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      // Example drSteps for testing syntax highlighting
      // const testMarkdown = "Here is some text.\n\n```bash\necho 'Hello, World!'\nls -la\n```\n\nAnd some more text.";
      // setDrSteps(testMarkdown);
      ...
      <div className="main-content">
        ...
        {drSteps && (
          <div className="result-section">
            ...
            {/* --- 2. PASS THE PLUGIN TO THE REACTMARKDOWN COMPONENT --- */}
